...
function initMap() {
  ...
  var info1 = new google.maps.InfoWindow({ content: '<p>Grassland Grocery <img src="https://abbottjord94.github.io/arcata-marsh-dev/images/GrasslandGrocery.jpeg" alt="Grassland Grocery trail sign"></p>'})
  ...
  var info2 = new google.maps.InfoWindow({ content: '<p>Look for Signs of River Otters<img src="https://abbottjord94.github.io/arcata-marsh-dev/images/RiverOtters.jpeg" alt="River Otters trail sign"></p>'})
  ...
  var info3 = new google.maps.InfoWindow({ content: '<p>Where is my Home?<img src="https://abbottjord94.github.io/arcata-marsh-dev/images/HomeMarker.jpeg" alt="My home trail sign"></p>'})
  ...
  var info4 = new google.maps.InfoWindow({ content: '<p>Black-crowned Night-Herons<img src="https://abbottjord94.github.io/arcata-marsh-dev/images/Herons.jpeg" alt="Night-Herons trail sign"></p>'})
  ...
  var info5 = new google.maps.InfoWindow({ content: '<p>The Changing Face of a Place<img src="https://abbottjord94.github.io/arcata-marsh-dev/images/ChangingFace.jpeg" alt="Changing Face trail sign"></p>'})
